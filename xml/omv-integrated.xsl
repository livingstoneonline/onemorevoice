...
<!-- Useful for DTDs https://www.w3.org/TR/xhtml1/dtds.html#h-A2 -->
	...
	<xsl:template match="/">
		...
		<html lang="en">
			<head>
				...
				<link rel="preload" as="style" href="/css/style.css?=newVers_0026" onload="this.rel='stylesheet'"></link>
				...
				<noscript>
					<link rel="stylesheet" type="text/css" href="/css/style.css?=newVers_0026"></link>
			...
			<body class="transcription materials" id="body">
				...
				<script>
					...
					$(window).on("load",function(){var element=document.createElement("script");element.type="text/javascript";element.src="/js/scripts.js?=newVers_0024";document.body.appendChild(element)});
	...
	<xsl:template match="TEI">
		...
		<xsl:variable name="edition">
			...
			<xsl:if test="//teiHeader//publicationStmt/date[contains(text(), '2024')]">
				<xsl:text>solidarity edition, 2023-24</xsl:text>
			</xsl:if>
		</xsl:variable>
