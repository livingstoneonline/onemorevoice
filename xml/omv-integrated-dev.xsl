	...
	<xsl:template match="/">
		...
		<html lang="en">
			<head>
				...
				<link rel="preload" as="style" href="https://onemorevoice.org/css/critical.css?=newVers_0010" onload="this.rel='stylesheet'"/>
				<link rel="preload" as="style" href="https://onemorevoice.org/css/style.css?=newVers_0011" onload="this.rel='stylesheet'"/>
				...
				<link rel="preload" as="script" href="https://onemorevoice.org/js/scripts.js?=newVers_0011"/>
				...
				<link rel="stylesheet" type="text/css" href="https://onemorevoice.org/css/critical.css?=newVers_0010"/>
				<script>
			...
			<body class="transcription " id="body"><!-- style="background:#{$body-color};" -->
					...
					<div class="page-wrapper">
						...
						<header id="header">
							<div class="image-wrapper">
								<img class="image-border" width="700" height="174"  src="https://onemorevoice.org/img/main-pages/liv_023005_0001_deriv-1396px.jpg" srcset="https://onemorevoice.org/img/main-pages/liv_023005_0001_deriv-1396px.jpg 1396w, https://onemorevoice.org/img/main-pages/liv_023005_0001_deriv-956px.jpg 956w, https://onemorevoice.org/img/main-pages/liv_023005_0001_deriv-698px.jpg 698w, https://onemorevoice.org/img/main-pages/liv_023005_0001_deriv-636px.jpg 636w, https://onemorevoice.org/img/main-pages/liv_023005_0001_deriv-478px.jpg 478w, https://onemorevoice.org/img/main-pages/liv_023005_0001_deriv-318px.jpg 318w" sizes="(min-width: 740px) 698px, 95.24vw" alt="Coded text from an XML file produced by One More Voice according to the TEI P5 guidelines." title="A segment of coded text from One More Voice." />
							</div>
						</header>
				...
				<link rel="stylesheet" type="text/css" href="https://onemorevoice.org/css/style.css?=newVers_0011"/>
				...
				<script>
					...
					$(function(){var includes=$('[data-include]');jQuery.each(includes,function(){var file='https://onemorevoice.org/common/'+$(this).data('include')+'.html?=newVers_0003';$(this).load(file)})});
				</script>
				...
				<script>
					...
					$(window).on("load",function(){var element=document.createElement("script");element.src="/js/scripts.js?=newVers_0011";document.body.appendChild(element)});
				...
				<!-- <script src="https://onemorevoice.org/js/scripts.js?=newVers_0011"></script> -->
			</body>
		</html>
	</xsl:template>
