	...
	<xsl:template match="/">
		...
		<html lang="en">
			<head>
				...
				<link rel="preload" as="style" href="/css/critical.css?=newVers_0005" onload="this.rel='stylesheet'"/>
				<link rel="preload" as="style" href="/css/style.css?=newVers_0005" onload="this.rel='stylesheet'"/>
				...
				<link rel="stylesheet" type="text/css" href="/css/critical.css?=newVers_0005"/>
				<script>
			...
			<body class="transcription " id="body"><!-- style="background:#{$body-color};" -->
				...
				<link rel="stylesheet" type="text/css" href="/css/style.css?=newVers_0005"/>
