	...
	<xsl:template match="/">
		...
		<html lang="en">
			<head>
				...
				<link rel="preload" as="style" href="/css/style.css?=newVers_0022" onload="this.rel='stylesheet'"></link>
				...
				<noscript>
					<link rel="stylesheet" type="text/css" href="/css/style.css?=newVers_0022"></link>
				...
				<link rel="stylesheet" type="text/css" href="/css/critical.css?=newVers_0023"></link>
			...
			<body class="transcription materials" id="body">
				...
				<script>
					...
					$(window).on("load",function(){var element=document.createElement("script");element.type="text/javascript";element.src="/js/scripts.js?=newVers_0019";document.body.appendChild(element)});
