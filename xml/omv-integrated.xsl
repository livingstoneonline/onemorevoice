		...
		<html lang="en">
			<head>
				...
				<xsl:if test="/TEI/text[contains(@n,'rotate-toggle')]">
					<link rel="preload" as="style" href="/css/rotate-toggle.css?=newVers_0001" onload="this.rel='stylesheet'"/>
				</xsl:if>
			...
			<body class="transcription " id="body"><!-- style="background:#{$body-color};" -->
				...
				<xsl:if test="/TEI/text[contains(@n,'rotate-toggle')]">
					<link rel="stylesheet" type="text/css" href="/css/rotate-toggle.css?=newVers_0001"/>
				</xsl:if>
