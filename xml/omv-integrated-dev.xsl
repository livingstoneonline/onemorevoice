	...
	<xsl:template match="/">
		...
		<html lang="en">
			<head>
				...
				<link rel="preload" as="style" href="https://onemorevoice.org/css/critical.css?=newVers_0002" onload="this.rel='stylesheet'"/>
				<link rel="preload" as="style" href="https://onemorevoice.org/css/style.css?=newVers_0002" onload="this.rel='stylesheet'"/>
				...
				<link rel="preload" as="script" href="https://onemorevoice.org/js/scripts.js?=newVers_0002"/>
				...
				<link rel="stylesheet" type="text/css" href="https://onemorevoice.org/css/critical.css?=newVers_0002"/>
				<script>
			...
			<body class="transcription " id="body"><!-- style="background:#{$body-color};" -->
				...
				<link rel="stylesheet" type="text/css" href="https://onemorevoice.org/css/style.css?=newVers_0002"/>
				...
				<script>
					...
					$(window).on("load",function(){var element=document.createElement("script");element.src="https://livingstoneonline.github.io/onemorevoice/js/scripts.js?=newVers_0002";document.body.appendChild(element)});
				</script>
				<!-- <script src="https://onemorevoice.org/js/scripts.js?=newVers_0002"></script> -->
			</body>
		</html>
	</xsl:template>
