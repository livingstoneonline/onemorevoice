	...
	<xsl:template match="/">
		...
		<html lang="en">
			<head>
				...
				<link rel="preload" as="style" href="/css/critical.css?=newVers_0020" onload="this.rel='stylesheet'"/>
				<link rel="preload" as="style" href="/css/style.css?=newVers_0019" onload="this.rel='stylesheet'"/>
				...
				<link rel="preload" as="script" href="/js/scripts.js?=newVers_0017"/>
				...
				<link rel="stylesheet" type="text/css" href="/css/critical.css?=newVers_0020"/>
			...
			<body class="transcription materials" id="body">
				...
				<link rel="stylesheet" type="text/css" href="/css/style.css?=newVers_0019"/>
				...
				<script>
					...
					$(function(){var includes=$('[data-include]');jQuery.each(includes,function(){var file='/common/'+$(this).data('include')+'.html?=newVers_0006';$(this).load(file)})});
				</script>
				<script>
				...
				<script>
					...
					$(window).on("load",function(){var element=document.createElement("script");element.type="text/javascript";element.src="/js/scripts.js?=newVers_0017";document.body.appendChild(element)});
