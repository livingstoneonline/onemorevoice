	...
	<xsl:template match="/">
		...
		<html lang="en">
			...
			<body class="transcription " id="body"><!-- style="background:#{$body-color};" -->
				<nav class="navigation fallback"><div class="nav-wrapper"><div class="subnav-wrapper"><a id="nav2" href="../../index.html"><img src="../../img/OMV-logo-78px.jpg" srcset="../../img/OMV-logo-78px.jpg 78w, ../../img/OMV-logo-72px.jpg 72w, ../../img/OMV-logo-58px.jpg 58w, ../../img/OMV-logo-39px.jpg 39w, ../../img/OMV-logo-36px.jpg 36w, ../../img/OMV-logo-29px.jpg 29w" sizes="(min-width: 768px) 39px, (min-width: 480px) 36px, 29px" alt="One More Voice logo in white on a blue field." title="Home"/></a><a id="nav3" href="index.html"><h1>One More Voice</h1></a></div><a id="nav5" href="../../site_sections.html"><i class="fa fa-bars"></i></a></div></nav>
