		...
		<html lang="en">
			...
			<body class="transcription materials" id="body">
				...
				<script>
					...
					$(window).on("load",function(){var element=document.createElement("script");element.type="text/javascript";element.src="/js/scripts.js?=newVers_0023";document.body.appendChild(element)});
