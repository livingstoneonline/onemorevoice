	...
	<xsl:template match="/">
		...
		<html lang="en">
			<head>
				...
				<link rel="preload" as="style" href="../../css/critical.css?=newVers_0003" onload="this.rel='stylesheet'"/>
				<link rel="preload" as="style" href="../../css/style.css?=newVers_0003" onload="this.rel='stylesheet'"/>
				...
				<link rel="preload" as="script" href="../../js/scripts.js?=newVers_0002"/>
				...
				<link rel="stylesheet" type="text/css" href="../../css/critical.css?=newVers_0003"/>
				<script>
			...
			<body class="transcription " id="body"><!-- style="background:#{$body-color};" -->
				...
				<link rel="stylesheet" type="text/css" href="../../css/style.css?=newVers_0003"/>
				...
				<script>
					...
					$(window).on("load",function(){var element=document.createElement("script");element.src="../../js/scripts.js?=newVers_0002";document.body.appendChild(element)});
				</script>
				<!-- <script src="../../js/scripts.js?=newVers_0002"></script> -->
			</body>
		</html>
	</xsl:template>
