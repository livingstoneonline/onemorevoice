	...
	<xsl:template match="/">
		...
		<html lang="en">
			<head>
				...
				<link rel="preload" as="style" href="https://onemorevoice.org/css/critical.css?=newVers_0003" onload="this.rel='stylesheet'"/>
				<link rel="preload" as="style" href="https://onemorevoice.org/css/style.css?=newVers_0003" onload="this.rel='stylesheet'"/>
				...
				<link rel="stylesheet" type="text/css" href="https://onemorevoice.org/css/critical.css?=newVers_0003"/>
				<script>
			...
			<body class="transcription " id="body"><!-- style="background:#{$body-color};" -->
				...
				<link rel="stylesheet" type="text/css" href="https://onemorevoice.org/css/style.css?=newVers_0003"/>
