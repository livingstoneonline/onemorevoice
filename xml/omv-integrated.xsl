	...
	<xsl:template match="/">
		...
		<html lang="en">
			<head>
				...
				<link rel="preload" as="style" href="/css/critical.css?=newVers_0011" onload="this.rel='stylesheet'"/>
				...
				<link rel="preconnect" as="script" href="/js/scripts.js?=newVers_0011"/>
				...
				<link rel="stylesheet" type="text/css" href="/css/critical.css?=newVers_0011"/>
			...
			<body class="transcription materials" id="body">
				...
				<script>
					...
					$(window).on("load",function(){var element=document.createElement("script");element.type="text/javascript";element.src="/js/scripts.js?=newVers_0011";document.body.appendChild(element)});
		...
		<xsl:variable name="text-object-details">
			...
			<xsl:choose>
				<xsl:when test="//sourceDesc/msDesc[@type='manuscript']">
					...
					<p><strong>Form &amp; transmission history:</strong><xsl:text> </xsl:text><xsl:value-of select="//teiHeader//sourceDesc/msDesc/history"/></p>
