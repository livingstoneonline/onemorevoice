	...
	<xsl:template match="/">
		...
		<html lang="en">
			<head>
				...
				<link rel="preload" as="script" href="/js/scripts.js?=newVers_0006"/>
			...
			<body class="transcription " id="body"><!-- style="background:#{$body-color};" -->
				...
				<script>
					...
					$(window).on("load",function(){var element=document.createElement("script");element.src="/js/scripts.js?=newVers_0006";document.body.appendChild(element)});
				</script>
				<!-- <script src="/js/scripts.js?=newVers_0006"></script> -->
			</body>
		</html>
	</xsl:template>
